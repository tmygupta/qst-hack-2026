...
- Case 4 - Infrastructure Optimization (KPMG)  
- Case 5 - Towards QC applications in weather/climate (Qpurpose)
- Case 6 - Quantum optical state geneator with machine learning (DTU)
